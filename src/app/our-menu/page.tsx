...
export default function MenuView() {
  ...
  const [search, setSearch] = useState<string | null>(null); // State for search
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <Suspense fallback={<div>Loading search parameters...</div>}>
        <SearchParams setSearch={setSearch} />
      </Suspense>
...
// New component to handle search parameters
const SearchParams = ({ setSearch }: { setSearch: React.Dispatch<React.SetStateAction<string | null>> }) => {
